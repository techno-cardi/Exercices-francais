...
function progressTable(progress) {
  ...
  const previewSuffix = ['127.0.0.1', 'localhost'].includes(location.hostname) && new URLSearchParams(location.search).get('apercu') === '1' ? '&apercu=1&role=enseignant' : '';
